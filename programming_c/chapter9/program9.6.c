/*******************************************************************************
 * Program 9.6 from Programming in C
 * File:    program9.6.c
 * 
 * Victor Barriga 
 * victorbarriga@live.com
 * 
 * Program displays the time as represented by that element, calls the 
 * timeUpdate function from Program 9.5, and then displays the updated time.
 *
*******************************************************************************/
...
int main (void)
{
	...
	struct time test_times[5] = { { 11, 59, 59 },
								  { 12,  0,  0 },
								  {  1, 29, 59 },
								  { 23, 59, 59 },
								  { 19, 12, 27 } };
