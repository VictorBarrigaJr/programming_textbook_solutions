 ...
 * 
 * This program demonstrates the math functions from the C math.h library, so theat you 
 * can get your homework right thanks to some quick-and-easy programming.
 *
 */
...
int main()
{
    printf("It's time to do yor math homework.\n");
