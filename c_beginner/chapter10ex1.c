/**
 * Example program #1 from Chapter 10 of Absolute Begnner's Guide to C, 3rd Edition
 * File:    chapter10e103.c
 * 
 * Victor Barriga 
 * victorbarriga@live.com
 * 
 * this program increases a counter from 1 to 5, printing updates and then conts it bak down to 1.
 */
 ...
 int main()
 {
    ...
    ctr = ctr - 1; // dereases counter to 4
    printf ("Counter is at %d.\n", ctr);
